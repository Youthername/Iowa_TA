...
\begin{frame}{Integration Methods: Quick Review}
  \begin{itemize}
    ...
    \item Optional advanced method (skip if time is tight)
  \end{itemize}
  \vspace{4pt}
  \[
...
\begin{frame}{Class Reminder: Exam Questions}
  \begin{itemize}
    \item Do not discuss specific exam questions in class.
    \item If students ask, invite them to office hours.
    \item Suggested response: \\
    ``I cannot discuss exam details in class, but I can help during office hours.''
  \end{itemize}
\end{frame}
